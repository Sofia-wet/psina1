		...
		<div id="product_addons_editor" class="tabcontent">
			...
			<?php }else{ ?>
				...
				<div class="vw-kids-pattern-page">
					...
					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woo Settings','vw-kids'); ?></span></b></p>
	              	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/product-addon.png" alt="" />
	              	<div class="vw-kids-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-kids'); ?></a>
			    	</div>
